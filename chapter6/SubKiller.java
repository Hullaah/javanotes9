 ...
 * a "boat" (a blue round-rect).  The user moves the boat with the left- and
...
public class SubKiller extends Application {
    ...
    public void  draw() {
        ...
        if (stage.isFocused()) {
            ...
            g.fillText(String.format("Hits: %s\nMisses: %s\n", boat.hits, boat.misses), 400, 30);
        ...
        void draw(GraphicsContext g) {  // Draw sub and, if it is exploding, the explosion.
            ...
            if (isExploding) {
                ...
                g.fillOval(centerX - 1.5*explosionFrameNumber,
                        centerY - explosionFrameNumber/2.0,
                        3*explosionFrameNumber,
                        explosionFrameNumber);
            }
        }
