...
public class SimpleTrackMouse extends Application {
    ...
    public void start(Stage stage) {
        ...
        scene.addEventFilter(MouseEvent.ANY, this::mouseEventOnScene);
    ...
    private void mouseEventOnCanvas(MouseEvent evt, String eventType) {
        eventInfo.append(eventType).append(" on canvas at (");
        eventInfo.append((int) evt.getX()).append(",").append((int) evt.getY()).append(")\n");
        if (eventType.equals("Mouse Pressed") || eventType.equals("Mouse Released") 
                || eventType.equals("Mouse Clicked")) {
            eventInfo.append("Mouse button pressed or released: ").append(evt.getButton()).append("\n");
        }
        if (eventType.equals("Mouse Clicked")) {
            eventInfo.append("Click count: ").append(evt.getClickCount()).append("\n");
        }
